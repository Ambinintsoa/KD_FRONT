...
import { RendezVousService } from '../../service/rendez-vous-service.service'; // Importer le service
@Component({
  selector: 'app-client-rendez-vous',
  imports: [FullCalendarModule],
  template:  '<full-calendar [options]="calendarOptions"></full-calendar>',
  styleUrl: './client-rendez-vous.component.scss'
})
export class ClientRendezVousComponent implements OnInit {
  ...
  loadEvents() {
    ...
    this.rendezvousService.getRendezVousClient().subscribe(
      (data) => {  
