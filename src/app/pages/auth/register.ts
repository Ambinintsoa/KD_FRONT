        ...
        <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, var(--primary-color) 10%, rgba(33, 150, 243, 0) 30%)">
            <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20" style="border-radius: 53px">
                <div class="text-center mb-8">
                    ...
                    <div class="text-surface-900 dark:text-surface-0 text-3xl font-medium mb-4">Inscrivez-vous !</div>
                    <span class="text-muted-color font-medium">Rejoignez-nous en quelques étapes</span>
                </div>
                ...
                <div>
                    ...
                    <label for="nom" class="block text-surface-900 dark:text-surface-0 text-xl font-medium mb-2">Nom</label>
                    <input pInputText id="nom" type="text" placeholder="Votre nom" class="w-full md:w-[30rem] mb-8" [(ngModel)]="nom" />
                    <label for="prenom" class="block text-surface-900 dark:text-surface-0 text-xl font-medium mb-2">Prénom</label>
                    <input pInputText id="prenom" type="text" placeholder="Votre prénom" class="w-full md:w-[30rem] mb-8" [(ngModel)]="prenom" />
                    ...
                    <p-password id="password2" [(ngModel)]="confirmPassword" placeholder="Confirmer le mot de passe" [toggleMask]="true" styleClass="mb-8" [fluid]="true" [feedback]="false"></p-password>

                    <div class="flex items-center justify-between mb-8">
                        <div class="flex items-center">
                            <p-checkbox [(ngModel)]="checked" id="acceptTerms" binary class="mr-2"></p-checkbox>
                            <label for="acceptTerms">Accepter les conditions</label>
                        </div>
                    </div>
                    <p-button label="S'inscrire" styleClass="w-full" (click)="register()"></p-button>
                </div>
            </div>
        </div>
    </div>
...
export class Register {
    ...
    register() {
        ...
        // Ajoutez ici votre logique d'inscription (ex. appel API)
      }
}
